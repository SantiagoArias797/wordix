...
/*Modulo que muestra un mensaje de bienvenida al usuario, que usa como parametro $usuario
y no devuelve ningun valor pero si texto en pantalla.
 */
...
/*Este modulo analiza una palabra a partir de una cadena de texto ingresada por el usuario
usa el strlen para ver la cantidad de caracteres de $cadena y luego a la misma analiza 
que sus letras sean de a-z con ctype_alpha y luego retorna true o false @return boolean $esLetra.
 */
...
/*Este modulo le pide al usuario que ingrese una palabra de 5 letras, luego usa la funcion @strtoupper
que convierte todas sus letras en mayuscula y luego analiza si de verdad esa palabra es de 5 letras con 
strlen si no es verdad le pide que ingrese una nueva palabra de 5 letras y luego retorna @return string $palabra.
Usa como parametros. 
*/
...
function jugarWordix($palabraWordix, $nombreUsuario)
{
    ...
    if ($ganoElIntento) {
        $nroIntento--;
        $puntaje = obtenerPuntajeWordix($cantIntentos, $palabra);
